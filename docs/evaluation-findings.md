...
- *"Why did you use a coding agent?"* → "The course is INST0100: Generative AI for Information Processing. Using a generative AI coding agent to build a generative AI system *is* the course's subject matter. I authored the specifications and architectural decisions; the implementation was developed in close collaboration with the agent against those specifications. The empirical findings, design rationale, and analytical work in this document are mine. The architectural choices and their justifications are graded at the level the rubric describes for Defence."
